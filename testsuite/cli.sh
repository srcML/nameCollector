...
expected=$(cat <<EOF
Set is a constructor in C++ file: test_set.cpp:4:6
i is a int local in C++ file: test_set.cpp:5:14
Set is a constructor in C++ file: test_set.cpp:10:6
x is a int parameter in C++ file: test_set.cpp:10:14
cardinality is a unsigned int function in C++ file: test_set.cpp:14:19
card is a unsigned int local in C++ file: test_set.cpp:15:18
i is a size_t local in C++ file: test_set.cpp:16:16
operator+ is a Set function in C++ file: test_set.cpp:24:10
rhs is a const Set& parameter in C++ file: test_set.cpp:24:31
result is a Set local in C++ file: test_set.cpp:25:9
i is a size_t local in C++ file: test_set.cpp:26:16
operator* is a Set function in C++ file: test_set.cpp:32:10
rhs is a const Set& parameter in C++ file: test_set.cpp:32:31
result is a Set local in C++ file: test_set.cpp:33:9
i is a size_t local in C++ file: test_set.cpp:34:16
operator- is a Set function in C++ file: test_set.cpp:40:10
rhs is a const Set& parameter in C++ file: test_set.cpp:40:31
result is a Set local in C++ file: test_set.cpp:41:9
i is a size_t local in C++ file: test_set.cpp:42:16
operator~ is a Set function in C++ file: test_set.cpp:48:10
result is a Set local in C++ file: test_set.cpp:49:9
i is a size_t local in C++ file: test_set.cpp:50:16
operator== is a bool function in C++ file: test_set.cpp:56:11
rhs is a const Set& parameter in C++ file: test_set.cpp:56:33
i is a size_t local in C++ file: test_set.cpp:57:16
operator<= is a bool function in C++ file: test_set.cpp:65:11
rhs is a const Set& parameter in C++ file: test_set.cpp:65:33
i is a size_t local in C++ file: test_set.cpp:66:16
operator<< is a std::ostream& function in C++ file: test_set.cpp:74:15
out is a std::ostream& parameter in C++ file: test_set.cpp:74:40
rhs is a const Set& parameter in C++ file: test_set.cpp:74:56
i is a size_t local in C++ file: test_set.cpp:76:16
operator!= is a bool function in C++ file: test_set.cpp:85:6
lhs is a const Set& parameter in C++ file: test_set.cpp:85:28
rhs is a const Set& parameter in C++ file: test_set.cpp:85:44
operator< is a bool function in C++ file: test_set.cpp:88:6
lhs is a const Set& parameter in C++ file: test_set.cpp:88:28
rhs is a const Set& parameter in C++ file: test_set.cpp:88:44
operator>= is a bool function in C++ file: test_set.cpp:91:6
lhs is a const Set& parameter in C++ file: test_set.cpp:91:28
rhs is a const Set& parameter in C++ file: test_set.cpp:91:44
operator> is a bool function in C++ file: test_set.cpp:94:6
lhs is a const Set& parameter in C++ file: test_set.cpp:94:28
rhs is a const Set& parameter in C++ file: test_set.cpp:94:44
NAMECOLLECTOR_SET_HPP_ is a macro in C++ file: test_set.hpp:2:9
COLLECTION_SIZE is a const unsigned int global in C++ file: test_set.hpp:6:20
Set is a class in C++ file: test_set.hpp:9:7
Set is a constructor in C++ file: test_set.hpp:11:5
Set is a constructor in C++ file: test_set.hpp:12:5
cardinality is a unsigned int function in C++ file: test_set.hpp:14:18
operator[] is a bool function in C++ file: test_set.hpp:15:10
operator+ is a Set function in C++ file: test_set.hpp:17:9
operator* is a Set function in C++ file: test_set.hpp:18:9
operator- is a Set function in C++ file: test_set.hpp:19:9
operator~ is a Set function in C++ file: test_set.hpp:21:9
operator== is a bool function in C++ file: test_set.hpp:23:10
operator<= is a bool function in C++ file: test_set.hpp:24:10
operator<< is a std::ostream& function in C++ file: test_set.hpp:26:26
member is a bool field in C++ file: test_set.hpp:29:10
operator!= is a bool function in C++ file: test_set.hpp:33:6
operator< is a bool function in C++ file: test_set.hpp:34:6
operator>= is a bool function in C++ file: test_set.hpp:35:6
operator> is a bool function in C++ file: test_set.hpp:36:6
main is a int function in C++ file: test_set_main.cpp:4:5
x is a Set local in C++ file: test_set_main.cpp:5:9
y is a Set local in C++ file: test_set_main.cpp:6:9
z is a Set local in C++ file: test_set_main.cpp:14:9
a is a Set local in C++ file: test_set_main.cpp:16:9
EOF
)
if [[ "$output" != "$expected" ]]; then
